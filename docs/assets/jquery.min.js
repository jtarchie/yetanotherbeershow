...
(function (E, B) {
  ...
  function Ka(a) {
    ...
    if (
      !(a.liveFired === this || !h || !h.live || a.button && a.type === "click")
    ) {
      if (a.namespace) {
        A = RegExp(
    ...
    c = function () {
      ...
      b.extend({
        ...
        isPlainObject: function (j) {
          if (
            !j || b.type(j) !== "object" || j.nodeType || b.isWindow(j)
          ) return false;
          if (
            j.constructor &&
        ...
        each: function (j, s, v) {
          ...
          if (v) {
            ...
            for (z in j) if (s.call(j[z], z, j[z]) === false) break;
        ...
        makeArray: function (j, s) {
          ...
          if (j != null) {
            var z = b.type(j);
            j.length == null || z === "string" || z === "function" ||
              z === "regexp" || b.isWindow(j)
              ? M.call(v, j)
              : b.merge(v, j);
          }
          return v;
  ...
  (function () {
    ...
    if (!(!f || !f.length || !h)) {
      ...
      c.support.checkClone =
        a.cloneNode(true).cloneNode(true).lastChild.checked;
      c(function () {
        ...
        if (b) {
          ...
          if (c.nodeName(b, "select")) {
            ...
            for (e = b ? e + 1 : f.length; h < e; h++) {
              var l = f[h];
              if (
                l.selected && (c.support.optDisabled
                  ? !l.disabled
  ...
  c.extend({
    ...
    attr: function (a, b, d, e) {
      ...
      if ((b in a || a[b] !== B) && e && !h) {
        if (f) {
          b === "type" && Ua.test(a.nodeName) && a.parentNode &&
  ...
  c.event = {
    ...
    trigger: function (a, b, d, e) {
      ...
      if (!e) {
        a = typeof a === "object"
          ? a[c.expando] ? a : c.extend(c.Event(f), a)
          : c.Event(f);
        if (f.indexOf("!") >= 0) {
      ...
      if (!a.isPropagationStopped() && e) c.event.trigger(a, b, e, true);
        ...
        var k = f.replace(X, ""),
          ...
          x = c.event.special[k] || {};
        if (
          (!x._default || x._default.call(d, a) === false) && !o &&
      ...
      setup: function () {
        if (
          ...
          c.event.add(this, "click.specialSubmit", function (a) {
            ...
            if (
              (d === "submit" || d === "image") && c(b).closest("form").length
            ) {
              a.liveFired = B;
          ...
          c.event.add(this, "keypress.specialSubmit", function (a) {
            ...
            if (
              (d === "text" || d === "password") &&
              c(b).closest("form").length && a.keyCode === 13
            ) {
              a.liveFired = B;
              return la("submit", this, arguments);
            }
  ...
  (function () {
    ...
    var k = function (g, i, n, m) {
      ...
      if (D.length > 1 && x.exec(g)) {
        ...
        if (
          !m && D.length > 1 && i.nodeType === 9 && !O &&
          o.match.ID.test(D[0]) && !o.match.ID.test(D[D.length - 1])
        ) {
          q = k.find(D.shift(), i, O);
          i = q.expr ? k.filter(q.expr, q.set)[0] : q.set[0];
        }
        if (i) {
          q = m ? { expr: D.pop(), set: C(m) } : k.find(
            D.pop(),
        ...
        preFilter: {
          ...
          PSEUDO: function (g, i, n, m, p) {
            if (g[1] === "not") {
              ...
              o.match.POS.test(g[0]) || o.match.CHILD.test(g[0])
            ) return true;
            return g;
          },
          POS: function (g) {
        ...
        filter: {
          PSEUDO: function (g, i, n, m) {
            ...
            if (q) return q(g, n, i, m);
              ...
              return (g.textContent || g.innerText || k.getText([g]) || "")
                .indexOf(i[3]) >= 0;
            } else if (p === "not") {
              i = i[3];
              n = 0;
    ...
    (function () {
      ...
      if (
        g.firstChild && typeof g.firstChild.getAttribute !== "undefined" &&
          ...
          k = function (m, p, q, u) {
            ...
            if (!u && !k.isXML(p)) {
              if (p.nodeType === 9) {
                ...
                p.nodeType === 1 && p.nodeName.toLowerCase() !== "object"
              ) {
    ...
    (function () {
      var g = t.documentElement,
        i = g.matchesSelector || g.mozMatchesSelector ||
          g.webkitMatchesSelector || g.msMatchesSelector,
        n = false;
      try {
  ...
  c.fn.extend({
    ...
    add: function (a, b) {
      ...
      return this.pushStack(
        !d[0] || !d[0].parentNode || d[0].parentNode.nodeType === 11 || !e[0] ||
          !e[0].parentNode || e[0].parentNode.nodeType === 11
          ? e
          : c.unique(e),
      );
    },
  ...
  c.extend({
    filter: function (a, b, d) {
      if (d) a = ":not(" + a + ")";
      return b.length === 1
        ? c.find.matchesSelector(b[0], a) ? [b[0]] : []
        : c.find.matches(a, b);
    },
    dir: function (a, b, d) {
      var e = [];
  ...
  c.fn.extend({
    ...
    domManip: function (a, b, d) {
      var e, f, h, l = a[0], k = [];
      if (
        !c.support.checkClone && arguments.length === 3 &&
  ...
  c.buildFragment = function (a, b, d) {
    ...
    if (
      ...
      b === t && !Ca.test(a[0]) && (c.support.checkClone || !Da.test(a[0]))
    ) {
      f = true;
  ...
  c.each({
    ...
    c.fn[a] = function (d) {
      ...
      if (
        f && f.nodeType === 11 && f.childNodes.length === 1 && d.length === 1
      ) {
        d[b](this[0]);
        return this;
      } else {
          ...
          if (typeof l === "string" && !eb.test(l)) l = b.createTextNode(l);
            ...
            if (!c.support.tbody) {
              ...
              for (
                ...
                c.nodeName(k[o], "tbody") && !k[o].childNodes.length &&
                  k[o].parentNode.removeChild(k[o]);
              }
            }
            !c.support.leadingWhitespace && $.test(l) &&
  ...
  c.fn.extend({
    ...
    serializeArray: function () {
      return this.map(function () {
        ...
        var d = c(this).val();
        return d == null ? null : c.isArray(d)
          ? c.map(d, function (e) {
  ...
  c.extend({
    ...
    ajax: function (a) {
      ...
      if (b.dataType === "jsonp") {
        if (h === "GET") {
          T.test(b.url) ||
            (b.url += (ja.test(b.url) ? "&" : "?") + (b.jsonp || "callback") +
              "=?");
        } else if (
          !b.data ||
          !T.test(b.data)
      ...
      if (
        b.dataType === "json" && (b.data && T.test(b.data) || T.test(b.url))
      ) {
  ...
  c.fn.offset = "getBoundingClientRect" in t.documentElement
    ? function (a) {
      ...
      return {
        ...
        left: d.left +
          (f.pageXOffset || c.support.boxModel && h.scrollLeft ||
            b.scrollLeft) -
